...
const strVert = require('./shaders/vertUV.js')
const strFrag = require('./shaders/fragUV.js')
...
loadObj('./assets/hook.obj', function (o) {
  const attributes = {
...
function render () {
  ...
  var cameraY = Math.sin(currTime) * cameraRadius
